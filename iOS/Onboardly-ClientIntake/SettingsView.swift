...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Onboardly - Client Intake Pro") {
                if purchases.isPro {
            ...
            Section("About") {
                Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/onboardly-app/privacy.html")!)
                Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/onboardly-app/terms.html")!)
                Text("Version 1.0")
